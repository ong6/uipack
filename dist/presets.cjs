...
var ReplayGlyph = () => /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("svg", { viewBox: "0 0 12 12", "aria-hidden": "true", children: [
  /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("path", { d: "M6 1.5a4.5 4.5 0 1 1-4.2 2.9", fill: "none", stroke: "currentColor", strokeWidth: "1.6", strokeLinecap: "round" }),
...
function Figure({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(FigureMotionContext.Provider, { value: motion, children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(FigureHoverContext.Provider, { value: hover, children: /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(
    "figure",
    {
      id: figId,
      ...
      children: [
        hasHead ? /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: "uipack__head", children: [
          ...
          showControls ? /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: "uipack__controls", children: [
            /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("button", { type: "button", className: "uipack__ctl uipack__ctl--motion", onClick: replay, children: [
              /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(ReplayGlyph, {}),
              " Replay"
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("button", { type: "button", className: "uipack__ctl uipack__ctl--motion", onClick: toggle, "aria-pressed": !playing, children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: `uipack__canvas uipack__canvas--${background}`, children: [
          /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("svg", { ref: wideRef, className: "uipack--wide", viewBox, role: "img", "aria-label": alt, children }),
          narrow ? /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("svg", { ref: narrowRef, className: "uipack--narrow", viewBox: narrowViewBox ?? viewBox, role: "img", "aria-label": alt, children: narrow }) : null
        ] })
      ]
    }
  ) }) });
...
function Node({
  ...
  const body = /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("g", { id, "data-uipack": "node", ...hoverAttrs(flow, void 0, hover), ...handlers, children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("text", { x: tx, y: ty, textAnchor: anchor, fontSize: size, fontWeight: 600, fill: accent ? "var(--uipack-accent)" : "currentColor", children: label }),
    sub ? /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("text", { x: tx, y: y + h / 2 + subSize + 2, textAnchor: anchor, fontSize: subSize, fontFamily: "var(--uipack-mono)", fill: "currentColor", fillOpacity: 0.75, children: sub }) : null
  ] });
...
function Packet({ points, kind = "request", shape, dur = 3, delay = 0, at = 0.5, r = 5, reverse, radius = 6, flow, trim: t = [2, 12], id }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("g", { id, "data-uipack": "packet", ...attrs, children: [
    /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(Token, { kind, shape, r }),
    /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("animateMotion", { dur: `${dur}s`, begin: `${delay}s`, repeatCount: "indefinite", path: d, calcMode: "linear" })
  ] });
}
...
function Stack({ steps, id, y0 = 24 }) {
  return /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)(import_jsx_runtime9.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(Defs, { id }),
    steps.map((s, i) => {
      const y = y0 + i * (SH + GAP);
      const into = [
        [SX + SW / 2, y - GAP],
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("g", { children: [
        i > 0 ? /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)(import_jsx_runtime9.Fragment, { children: [
          /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(Connector, { points: into, defs: id, kind: kind === "neutral" ? void 0 : kind, flow: s.flow }),
          /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(Packet, { points: into, kind, dur: 1.4, delay: -i * 0.35, reverse: s.back, flow: s.flow, r: 4 })
        ] }) : null,
        /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(Node, { x: SX, y, w: SW, h: SH, label: s.label, sub: s.sub, icon: s.icon, size: 13, subSize: 10, flow: s.flow, accent: s.accent, dashed: s.dashed })
      ] }, i);
    })
  ] });
}
...
function Group({ x, y, w, h, title, variant = "solid", accent, flow, titleSize, children }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("g", { "data-uipack": "group", ...hoverAttrs(flow, void 0, hover), children: [
    ...
    title ? dashed ? /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("text", { x: x + 16, y: y + 22, fontSize: ts, fontFamily: "var(--uipack-mono)", letterSpacing: ".08em", fill: stroke, fillOpacity: accent ? 1 : 0.75, children: title.toUpperCase() }) : /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("text", { x: x + w / 2, y: y + 24, textAnchor: "middle", fontSize: ts, fontWeight: 600, fill: stroke, children: title }) : null,
    children
  ] });
}
...
function Lane({ x, w, y, title, h, size = 11 }) {
  return /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("g", { "data-uipack": "lane", children: [
    /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("text", { x: x + w / 2, y, textAnchor: "middle", fontSize: size, fontWeight: 700, fontFamily: "var(--uipack-mono)", letterSpacing: ".08em", fill: "currentColor", children: title.toUpperCase() }),
    h ? /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("line", { x1: x + w, y1: y + 12, x2: x + w, y2: y + h, stroke: "currentColor", strokeOpacity: 0.15, strokeDasharray: "2 6" }) : null
  ] });
}
...
function serviceMapParts(spec = defaultServiceMap, id) {
  ...
  if (spec.sinks) {
    ...
    sinks = /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)(import_jsx_runtime13.Fragment, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(Connector, { points: viaPath, defs: id, kind: "change", flow: CDC }),
      /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(Packet, { points: viaPath, kind: "change", dur: 2, flow: CDC }),
      /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(Node, { ...via, label: spec.sinks.via.label, sub: spec.sinks.via.sub, icon: spec.sinks.via.icon ?? "queue", flow: CDC }),
      spec.sinks.items.map((s, i) => {
        ...
        return /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("g", { children: [
          /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(Connector, { points: p, defs: id, kind: "change", flow: CDC }),
          /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(Packet, { points: p, kind: "change", dur: 2.2, delay: -i * 0.55, flow: CDC }),
          /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(Node, { x: x0 + i * (sw + gap), y: sinkY, w: sw, h: 40, label: s.label, icon: s.icon, flow: CDC, size: 13 })
        ] }, s.label);
      })
    ] });
    height = sinkY + 40 + 24;
  }
  const wide = /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)(import_jsx_runtime13.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(Defs, { id }),
    /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(Lane, { x: client.x, w: client.w, y: 44, title: lc }),
    /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(Lane, { x: platform.x, w: platform.w, y: 44, title: lp }),
    /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(Lane, { x: store.x, w: store.w, y: 44, title: lr }),
    spec.clients.map((c, i) => /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(Node, { x: client.x, y: client.y0 + i * client.step, w: client.w, h: client.h, label: c.label, sub: c.sub, icon: c.icon, flow: READ }, c.label)),
    /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)(Group, { ...platform, title: spec.platform.title, flow: spec.sinks ? [READ, CDC] : READ, children: [
      spec.platform.cells.map((c, i) => /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(Node, { x: platform.x + 24 + i % 3 * 192, y: platform.y + 44 + Math.floor(i / 3) * 72, w: 168, h: 56, label: c.label, sub: c.sub, align: "left", flow: READ }, c.label)),
      spec.platform.footer ? /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(Node, { x: platform.x + 24, y: platform.y + 44 + rows * 72, w: 552, h: 56, label: spec.platform.footer.label, sub: spec.platform.footer.sub, align: "left", flow: READ }) : null
    ] }),
    spec.resources.map((r, i) => /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(Node, { x: store.x, y: store.y0 + i * store.step, w: store.w, h: store.h, label: r.label, sub: r.sub, icon: r.icon, flow: READ }, r.label)),
    /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(Bus, { ...clientBus, from: Math.min(clientY(0), trunkY), to: Math.max(clientY(spec.clients.length - 1), trunkY), defs: id }),
    /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(Bus, { ...storeBus, from: Math.min(storeY(0), trunkY), to: Math.max(storeY(spec.resources.length - 1), trunkY), defs: id }),
    /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(Packet, { points: toPlatform, kind: "request", dur: 2.4, flow: READ }),
    /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(Packet, { points: toPlatform, kind: "response", dur: 2.4, delay: -1.2, reverse: true, flow: READ }),
    /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(Packet, { points: fromPlatform, kind: "request", dur: 2.4, delay: -0.3, reverse: true, flow: READ }),
    /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(Packet, { points: fromPlatform, kind: "response", dur: 2.4, delay: -1.5, flow: READ }),
    spec.clients.map((_, i) => /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(Packet, { points: busStub(clientBus, clientBus.stubs[i]), kind: i % 2 ? "response" : "request", dur: 1.6, delay: -i * 0.4, reverse: i % 2 === 0, r: 4, flow: READ }, i)),
    spec.resources.map((_, i) => /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(Packet, { points: busStub(storeBus, storeBus.stubs[i]), kind: i % 2 ? "response" : "request", dur: 1.6, delay: -i * 0.5, reverse: i % 2 === 1, r: 4, flow: READ }, i)),
    sinks
  ] });
  const steps = [
  ...
  return {
    wide,
    narrow: /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(Stack, { steps, id: `${id}-n` }),
...
function Label({ x, y, text, anchor = "start", accent, size = 11, font = "mono" }) {
  const w = text.length * size * (font === "mono" ? 0.62 : 0.55) + 8;
  const rx = anchor === "middle" ? x - w / 2 : anchor === "end" ? x - w + 4 : x - 4;
  return /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)("g", { "data-uipack": "label", children: [
    /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("rect", { x: rx, y: y - size + 1, width: w, height: size + 5, fill: "var(--uipack-bg)" }),
...
function agentLoopParts(spec = defaultAgentLoop, id) {
  ...
  const wide = /* @__PURE__ */ (0, import_jsx_runtime15.jsxs)(import_jsx_runtime15.Fragment, { children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(Lane, { x: user.x, w: user.w, y: 44, title: lu }),
    /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(Lane, { x: agentBox.x, w: agentBox.w, y: 44, title: la }),
    /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(Lane, { x: tool.x, w: tool.w, y: 44, title: lt }),
    /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(Node, { ...user, label: spec.user.label, sub: spec.user.sub, icon: spec.user.icon ?? "user", flow: ASK, hint: "Sends the request, reads the output" }),
    /* @__PURE__ */ (0, import_jsx_runtime15.jsxs)(Group, { ...agentBox, title: spec.agent.label, flow: [ASK, TOOLS, CHECK], children: [
      /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(Node, { x: agentBox.x + 24, y: agentBox.y + 40, w: agentBox.w - 48, h: 56, label: spec.agent.sub ?? "plan \xB7 call \xB7 draft", sub: "model", icon: spec.agent.icon ?? "agent", flow: [ASK, TOOLS] }),
      /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(Node, { x: agentBox.x + 24, y: agentBox.y + 112, w: agentBox.w - 48, h: 40, label: "Draft", sub: "structured output", icon: "doc", flow: CHECK, size: 13, subSize: 10 })
    ] }),
    spec.tools.map((t, i) => /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(Node, { x: tool.x, y: tool.y0 + i * tool.step, w: tool.w, h: tool.h, label: t.label, sub: t.sub, icon: t.icon ?? "tool", flow: TOOLS }, t.label)),
    /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(Connector, { points: ask, defs: id, kind: "request", flow: ASK }),
    /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(Packet, { points: ask, kind: "request", dur: 2, flow: ASK }),
    /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(Packet, { points: ask, kind: "response", dur: 2, delay: -1, reverse: true, flow: ASK }),
    /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(Bus, { ...bus, from: Math.min(toolY(0), trunkY), to: Math.max(toolY(n - 1), trunkY), defs: id, kind: "change" }),
    /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(Packet, { points: fromAgent, kind: "change", dur: 1.8, flow: TOOLS }),
    /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(Packet, { points: fromAgent, kind: "response", dur: 1.8, delay: -0.9, reverse: true, flow: TOOLS }),
    spec.tools.map((_, i) => /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(Packet, { points: busStub(bus, bus.stubs[i]), kind: i % 2 ? "response" : "change", dur: 1.4, delay: -i * 0.45, reverse: i % 2 === 1, r: 4, flow: TOOLS }, i)),
    /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(Label, { x: (agentBox.x + agentBox.w + busX) / 2, y: trunkY - 10, text: "tool calls", anchor: "middle" }),
    /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(Connector, { points: toBoundary, defs: id, kind: "request", flow: CHECK }),
    /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(Packet, { points: toBoundary, kind: "request", dur: 1.6, flow: CHECK }),
    /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(Node, { ...boundary, label: spec.boundary.label, sub: spec.boundary.sub, icon: spec.boundary.icon ?? "lock", accent: true, dashed: true, flow: CHECK, hint: "Code, not a model, decides what passes" }),
    /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(Connector, { points: toOutput, defs: id, kind: "accent", flow: CHECK }),
    /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(Packet, { points: toOutput, kind: "accent", dur: 1.6, delay: -0.8, flow: CHECK }),
    /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(Label, { x: cx + 12, y: toOutput[0][1] + 28, text: "verdict", accent: true }),
    /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(Node, { ...output, label: spec.output.label, sub: spec.output.sub, icon: spec.output.icon ?? "doc", flow: CHECK })
  ] });
  const steps = [
...
function ragPipelineParts(spec = defaultRagPipeline, id) {
  ...
  const chain = (items, y, kind, flow) => items.slice(1).map((_, i) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)("g", { children: [
      /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(Connector, { points: p, defs: id, kind, flow }),
      /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(Packet, { points: p, kind, dur: 1.2, delay: -i * 0.4, r: 4, flow })
    ] }, i);
  });
  const wide = /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)(import_jsx_runtime16.Fragment, { children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(Lane, { x: src.x, w: src.w, y: 44, title: "Sources" }),
    /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(Lane, { x: stage.x0, w: ingestLast - stage.x0, y: 44, title: "Ingest" }),
    /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(Lane, { x: index.x, w: index.w, y: 44, title: "Index" }),
    /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(Lane, { x: stage.x0, w: sx(spec.stages.length - 1) + stage.w - stage.x0, y: 252, title: "Query" }),
    spec.sources.map((s, i) => /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(Node, { x: src.x, y: src.y0 + i * src.step, w: src.w, h: src.h, label: s.label, icon: s.icon ?? "doc", flow: INGEST, size: 13 }, s.label)),
    /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(Bus, { ...bus, from: Math.min(srcY(0), iy), to: Math.max(srcY(spec.sources.length - 1), iy), defs: id, kind: "change" }),
    spec.sources.map((_, i) => /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(Packet, { points: busStub(bus, bus.stubs[i]), kind: "change", dur: 1.4, delay: -i * 0.5, reverse: true, r: 4, flow: INGEST }, i)),
    /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(Packet, { points: busStub(bus, bus.stubs[spec.sources.length]), kind: "change", dur: 1.2, flow: INGEST, r: 4 }),
    spec.ingest.map((s, i) => /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(Node, { x: sx(i), y: ingestY, w: stage.w, h: stage.h, label: s.label, sub: s.sub, icon: s.icon, flow: INGEST, size: 13, subSize: 10 }, s.label)),
    chain(spec.ingest, iy, "change", INGEST),
    /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(Connector, { points: toIndex, defs: id, kind: "change", flow: INGEST }),
    /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(Packet, { points: toIndex, kind: "change", dur: 2, flow: INGEST }),
    /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(Node, { ...index, label: spec.index.label, sub: spec.index.sub, icon: spec.index.icon ?? "db", flow: [INGEST, QUERY2], hint: "Shared by both lanes" }),
    /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(Node, { x: src.x, y: queryY, w: src.w, h: stage.h, label: spec.query.label, icon: spec.query.icon ?? "user", flow: QUERY2, size: 13 }),
    /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(Connector, { points: queryIn, defs: id, kind: "request", flow: QUERY2 }),
    /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(Packet, { points: queryIn, kind: "request", dur: 1.2, flow: QUERY2, r: 4 }),
    spec.stages.map((s, i) => /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(Node, { x: sx(i), y: queryY, w: stage.w, h: stage.h, label: s.label, sub: s.sub, icon: s.icon, flow: QUERY2, size: 13, subSize: 10 }, s.label)),
    chain(spec.stages, qy, "request", QUERY2),
    /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(Connector, { points: read, defs: id, kind: "request", flow: QUERY2 }),
    /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(Packet, { points: read, kind: "request", dur: 1.8, flow: QUERY2, r: 4 }),
    /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(Packet, { points: read, kind: "response", dur: 1.8, delay: -0.9, reverse: true, flow: QUERY2, r: 4 }),
    /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(Label, { x: (retrieveX + index.x) / 2, y: index.y + index.h / 2 + 6, text: "top-k", anchor: "middle" }),
    /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(Connector, { points: toAnswer, defs: id, kind: "response", flow: QUERY2 }),
    /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(Packet, { points: toAnswer, kind: "response", dur: 1.4, flow: QUERY2, r: 4 }),
    /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(Node, { ...answer, label: spec.answer.label, sub: spec.answer.sub, icon: spec.answer.icon ?? "doc", flow: QUERY2, size: 13, subSize: 10 })
  ] });
  const steps = [
...
function Chip({ x, y, w, h = 24, label, dashed, kind, flow, size = 10 }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime17.jsxs)("g", { "data-uipack": "chip", ...hoverAttrs(flow, kind === "accent" ? void 0 : kind, hover), children: [
    ...
    label ? /* @__PURE__ */ (0, import_jsx_runtime17.jsx)("text", { x: x + w / 2, y: y + h / 2 + size * 0.36, textAnchor: "middle", fontSize: size, fontWeight: 700, fontFamily: "var(--uipack-mono)", fill: "currentColor", children: label.toUpperCase() }) : null
  ] });
}
...
function skillLifecycleParts(spec = defaultSkillLifecycle, id) {
  ...
  const wide = /* @__PURE__ */ (0, import_jsx_runtime18.jsxs)(import_jsx_runtime18.Fragment, { children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime18.jsx)(Lane, { x: author.x, w: author.w, y: 44, title: "Author" }),
    /* @__PURE__ */ (0, import_jsx_runtime18.jsx)(Lane, { x: evaluate.x, w: evaluate.w, y: 44, title: "Evaluate" }),
    /* @__PURE__ */ (0, import_jsx_runtime18.jsx)(Lane, { x: version.x, w: version.w, y: 44, title: "Version" }),
    /* @__PURE__ */ (0, import_jsx_runtime18.jsx)(Lane, { x: con.x, w: con.w, y: 44, title: "Consumers" }),
    /* @__PURE__ */ (0, import_jsx_runtime18.jsx)(Node, { ...author, label: spec.author.label, sub: spec.author.sub, icon: spec.author.icon ?? "user", flow: [FWD, BACK] }),
    /* @__PURE__ */ (0, import_jsx_runtime18.jsx)(Connector, { points: a2e, defs: id, kind: "request", flow: FWD }),
    /* @__PURE__ */ (0, import_jsx_runtime18.jsx)(Packet, { points: a2e, kind: "request", dur: 1.4, flow: FWD, r: 4 }),
    /* @__PURE__ */ (0, import_jsx_runtime18.jsx)(Node, { ...evaluate, label: spec.evaluate.label, sub: spec.evaluate.sub, icon: spec.evaluate.icon ?? "chart", flow: FWD, hint: `Scored against: ${spec.evaluate.baseline}` }),
    /* @__PURE__ */ (0, import_jsx_runtime18.jsx)(Chip, { x: evaluate.x, y: evaluate.y + evaluate.h + 12, w: evaluate.w, h: 20, label: `baseline \xB7 ${spec.evaluate.baseline}`, size: 9, dashed: true }),
    /* @__PURE__ */ (0, import_jsx_runtime18.jsx)(Connector, { points: e2v, defs: id, kind: "accent", flow: FWD }),
    /* @__PURE__ */ (0, import_jsx_runtime18.jsx)(Packet, { points: e2v, kind: "accent", dur: 1.4, delay: -0.7, flow: FWD, r: 4 }),
    /* @__PURE__ */ (0, import_jsx_runtime18.jsx)(Label, { x: (e2v[0][0] + e2v[1][0]) / 2, y: cy - 10, text: "passes", anchor: "middle", accent: true }),
    /* @__PURE__ */ (0, import_jsx_runtime18.jsx)(Node, { ...version, label: spec.version.label, sub: spec.version.sub, icon: spec.version.icon ?? "git", flow: FWD }),
    /* @__PURE__ */ (0, import_jsx_runtime18.jsx)(Bus, { ...bus, from: Math.min(conY(0), cy), to: trunkEnd, defs: id }),
    /* @__PURE__ */ (0, import_jsx_runtime18.jsx)(Packet, { points: busStub(bus, bus.stubs[n]), kind: "request", dur: 1.2, flow: FWD, r: 4 }),
    spec.consumers.map((c, i) => /* @__PURE__ */ (0, import_jsx_runtime18.jsxs)("g", { children: [
      /* @__PURE__ */ (0, import_jsx_runtime18.jsx)(Packet, { points: busStub(bus, bus.stubs[i]), kind: "request", dur: 1.2, delay: -i * 0.4, flow: FWD, r: 4 }),
      /* @__PURE__ */ (0, import_jsx_runtime18.jsx)(Node, { x: con.x, y: con.y0 + i * con.step, w: con.w, h: con.h, label: c.label, sub: c.sub, icon: c.icon, flow: [FWD, BACK] })
    ] }, c.label)),
    /* @__PURE__ */ (0, import_jsx_runtime18.jsx)(Label, { x: (version.x + version.w + busX) / 2, y: cy - 10, text: "install", anchor: "middle" }),
    /* @__PURE__ */ (0, import_jsx_runtime18.jsx)(Connector, { points: back, defs: id, kind: "change", flow: BACK, dashed: true }),
    /* @__PURE__ */ (0, import_jsx_runtime18.jsx)(Packet, { points: back, kind: "change", dur: 3.2, flow: BACK }),
    /* @__PURE__ */ (0, import_jsx_runtime18.jsx)(Packet, { points: back, kind: "change", dur: 3.2, delay: -1.6, flow: BACK }),
    /* @__PURE__ */ (0, import_jsx_runtime18.jsx)(Label, { x: (busX + author.x) / 2, y: loopY - 10, text: `${spec.feedback.label} \xB7 ${spec.feedback.sub ?? ""}`.trim(), anchor: "middle" })
  ] });
  const steps = [
...
function syncLoopParts(spec = defaultSyncLoop, id) {
  ...
  const wide = /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)(import_jsx_runtime19.Fragment, { children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(Lane, { x: up.x, w: up.w, y: 44, title: "Upstream" }),
    /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(Lane, { x: con.x, w: con.w, y: 44, title: "Consumers" }),
    /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(Group, { ...up, title: spec.upstream.label, flow: [PULL, PUSH], children: items.map((it, i) => /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(Node, { x: up.x + 16, y: up.y + 40 + i * 64, w: up.w - 32, h: 48, label: it.label, sub: it.sub, icon: it.icon, align: "left", flow: [PULL, PUSH], size: 13, subSize: 10 }, it.label)) }),
    spec.consumers.map((c, i) => {
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)("g", { children: [
        c.plugin ? /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)(import_jsx_runtime19.Fragment, { children: [
          /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(Connector, { points: single, defs: id, kind: "request", dashed: true, flow: PULL }),
          /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(Packet, { points: single, kind: "request", dur: 2.6, delay: -i * 0.5, flow: PULL, r: 4 })
        ] }) : /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)(import_jsx_runtime19.Fragment, { children: [
          /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(Connector, { points: pull, defs: id, kind: "request", flow: PULL }),
          /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(Packet, { points: pull, kind: "request", dur: 2.4, delay: -i * 0.6, flow: PULL, r: 4 }),
          /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(Connector, { points: push, defs: id, kind: "change", flow: PUSH }),
          /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(Packet, { points: push, kind: "change", dur: 2.4, delay: -i * 0.6 - 1.2, flow: PUSH, r: 4 })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(Node, { x: con.x, y: con.y0 + i * con.step, w: con.w, h: con.h, label: c.label, sub: c.hooks ? `${c.sub ?? ""} \xB7 ${c.hooks[0]} \u2192 ${c.hooks[1]}`.replace(/^ · /, "") : c.sub, icon: c.icon, align: "left", flow: c.plugin ? PULL : [PULL, PUSH] })
      ] }, c.label);
    }),
    /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(Label, { x: (up.x + up.w + con.x) / 2, y: conY(0) - 16, text: spec.pull ?? "pull", anchor: "middle" }),
    /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(Label, { x: (up.x + up.w + con.x) / 2, y: conY(0) + 28, text: spec.push ?? "push", anchor: "middle" })
  ] });
  const steps = [
...
function beforeAfterParts(spec = defaultBeforeAfter, id) {
  ...
  const panel = (p, y, flow, pid) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(Group, { x: x0, y, w, h: panelH, title: p.title, variant: "dashed", flow, accent: changed2.size > 0, children: p.stages.map((s, i) => {
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime20.jsxs)("g", { children: [
        i > 0 ? /* @__PURE__ */ (0, import_jsx_runtime20.jsxs)(import_jsx_runtime20.Fragment, { children: [
          /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(Connector, { points: into, defs: id, kind: hot ? "accent" : "request", flow }),
          /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(Packet, { points: into, kind: hot ? "accent" : "request", dur: 1.2, delay: -i * 0.4, flow, r: 4, id: `${pid}-p${i}` })
        ] }) : null,
        /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(Node, { x, y: sy, w: stage.w, h: stage.h, label: s.label, sub: s.sub, icon: s.icon, accent: hot, flow, size: 13, subSize: 10 })
      ] }, s.label + i);
    }) });
  };
...
function pipelineParts(spec = defaultPipeline, id) {
  ...
  const nodes = slots.map((kind, slot) => {
    ...
    const edge = slot > 0 ? /* @__PURE__ */ (0, import_jsx_runtime21.jsxs)(import_jsx_runtime21.Fragment, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime21.jsx)(Connector, { points: into, defs: id, kind: kind === "queue" || slots[slot - 1] === "queue" ? "change" : "request", flow: FLOW }),
      /* @__PURE__ */ (0, import_jsx_runtime21.jsx)(Packet, { points: into, kind: kind === "queue" || slots[slot - 1] === "queue" ? "change" : "request", dur: 1.2, delay: -slot * 0.35, flow: FLOW, r: 4 })
    ] }) : null;
    if (kind === "queue") {
      const q = spec.queue;
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime21.jsxs)("g", { children: [
        edge,
        /* @__PURE__ */ (0, import_jsx_runtime21.jsx)(Group, { x: x(slot), y: stage.y - 16, w: stage.w, h: stage.h + 32, title: q.label, flow: FLOW, accent: true, children: Array.from({ length: depth }).map((_, k) => /* @__PURE__ */ (0, import_jsx_runtime21.jsx)(Chip, { x: x(slot) + 8 + k * (cw + 6), y: stage.y + 24, w: cw, h: 18, label: k < depth - 1 ? String(k + 1) : "", kind: k < depth - 1 ? "change" : void 0, dashed: k === depth - 1, size: 9, flow: FLOW }, k)) })
      ] }, "queue");
    }
    const s = spec.stages[si++];
    return /* @__PURE__ */ (0, import_jsx_runtime21.jsxs)("g", { children: [
      edge,
      /* @__PURE__ */ (0, import_jsx_runtime21.jsx)(Node, { x: x(slot), y: stage.y, w: stage.w, h: stage.h, label: s.label, sub: s.sub, icon: s.icon, flow: FLOW, size: 13, subSize: 10 })
    ] }, s.label);
  });
  const wide = /* @__PURE__ */ (0, import_jsx_runtime21.jsxs)(import_jsx_runtime21.Fragment, { children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime21.jsx)(Lane, { x: 24, w: width - 48, y: 44, title: spec.laneTitle ?? "Stages, left to right" }),
    nodes
  ] });
  const steps = [
