...
import { serviceMapParts, defaultServiceMap } from "../src/presets";
...
describe("presets", () => {
  ...
  it("a spec change reaches the drawing", () => {
    const parts = serviceMapParts({ ...defaultServiceMap, clients: [{ label: "Only client", icon: "client" }], sinks: undefined });
